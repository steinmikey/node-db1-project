...
- Write the following middleware inside `api/accounts/accounts-middleware.js`:
...
- Write CRUD for the `accounts` resource, using the middleware and model functions above wherever appropriate:
